...
def extract_metadata_with_openai(text_path, questions):
...
if __name__ == "__main__":
    ...
    questions = ["¿Numero Registro Oficial o Suplemento?",
                 "¿Fecha de publicación?", 
                 "¿Cual es el título?",
                 "¿Quien firma el documento?"]
    metadata = extract_metadata_with_openai("../REPOSITORIO_DOCUMENTOS/05_OCR/01_LY No. 0 LEY ORGANICA DEL SERVICIO PUBLICO DE ENERGIA ELECTRICA(418).txt", questions)
    print(metadata)  # Ver JSON estructurado
